...
train_X,train_Y,cross_X,cross_Y= get_training_data(0.80)
nn_train=neural_network(hidden_layer_size=3,neurons=20,iterations=500,learning_rate=0.01,activation_function='tan')
print('Training the model')
nn_train.fit(train_X,train_Y)
print('Score',nn_train.score(cross_X,cross_Y))
nn_train.store_weights('weights.txt')
